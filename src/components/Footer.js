        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/905513481332" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#ani-kuresi" className="text-gray-400 hover:text-white transition-colors">
                  Anı Küresi
                </a>
              </li>
              <li>
                <a href="#siparis" className="text-gray-400 hover:text-white transition-colors">
                  Sipariş Ver
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">+90 0551 348 1332</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-purple-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-400">info@filamentbiblo3d.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-purple-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-400">İzmir, Türkiye</span>
              </li>
            </ul>
          </div>
        </div>
